    ...
    <main className="bg-gray-100 h-screen flex items-center justify-center p-5">
      <div className="bg-white max-w-screen-sm flex flex-col md:flex-row gap-2 w-full shadow-lg p-5 rounded-3xl">
        <input
          ...
          required
          className="w-full rounded-full p-3 bg-gray-200 pl-5 outline-none ring ring-transparent focus:ring-green-500 focus:ring-offset-2 transition-shadow invalid:focus:ring-red-500 peer"
        />
